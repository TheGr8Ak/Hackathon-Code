...
# This is the old Green Corridor Agent - kept for reference
# The new Hospital AI System is in app/main.py
green_corridor_app = FastAPI(title="Green Corridor AI Agent (Legacy)")
...
@green_corridor_app.post("/telemetry/update")
...
@green_corridor_app.websocket("/ws/dashboard")
